...
const EmployeeEdit = () => {
  ...
  const handleUpdate = () => {
    ...
    if (!suppliers[sIndex].empList) suppliers[sIndex].empList = [];

    suppliers[sIndex].empList[eIndex] = formData;
    localStorage.setItem("supplierData", JSON.stringify(suppliers));

    toast.success(t("employee.updateSuccess"));
    setTimeout(() => navigate(`/supplier/supplieremp/${sIndex}`), 1000);
  };

  const handleCancel = () => {
    navigate(`/supplier/supplieremp/${sIndex}`);
  };
    ...
    <div className="container mt-3">
      ...
      >
        <div className="card-body d-flex justify-content-between align-items-center">
          ...
          <Link to={`/supplier/supplieremp/${sIndex}`} className="btn btn-primary">
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-4">
            ...
            <Select
              ...
              onChange={(selected) =>
                setFormData({ ...formData, employeeType: selected?.value || "" })
              }
