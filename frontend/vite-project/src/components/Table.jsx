...
const Table = ({ data, columns, totalRecords, onPaginationChange, onFilteredRowsChange, collapsed }) => {
  ...
  return (
    ...
    >
              ...
              return (
                <div key={cell.id} className="border-bottom w-100">
                  <div className="d-flex flex-column p-2 w-100">
                    ...
                    <div
                      className={`mt-0 d-flex ${collapsed ? "justify-content-end" : ""
                        }`}
                    >
                      <button
      ...
      {/* Pagination */}
      <div
        className={`d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mt-3 gap-2 ${darkMode ? "text-white" : ""
          }`}
      >
        ...
        <span>
          {pageIndex + 1} {t("table.of")} {pageCount} {t("table.pages")} ({totalRecords} {t("table.items")})
        </span>
