  ...
  return (
    <div className="container">
      <div className={cardClass}>
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center" style={{backgroundColor: darkMode ? "#3d3d3dff" : "#ffff",
