      ...
      <div className="card mb-4">
        <div className="card-body d-flex justify-content-between align-items-center">
          <h4 className="card-title mb-0" style={{ color: "#2d4059" }}>
            {t("employeemangement.employee.addemployeetitle")}
          </h4>
      ...
      <div className="card shadow-sm p-4">
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            ...
            >
              {t("employeemangement.employee.usertype")} <span className="text-danger">*</span>
            </label>
            <Select
          ...
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.zone")} <span className="text-danger">*</span>
            </label>
            <Select
              options={zoneOptions}
              value={
          ...
          >
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.id")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.firstname")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.lastname")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.mobile")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.email")} <span className="text-danger">*</span>
            </label>
            <input
              type="email"
          ...
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.password")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
          ...
          <div className="col-md-4">
            <label
              ...
              style={{ fontSize: "15px", fontWeight: 600 }}
            >
              {t("employeemangement.employee.designation")} <span className="text-danger">*</span>
            </label>
            <input
              type="text"
              className={`form-control ${
