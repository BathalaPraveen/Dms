            ...
            <div className="card mb-4">
                <div className="card-body d-flex justify-content-between align-items-center">
                    <h4 className="card-title mb-0" style={{ color: "#2d4059" }}>
                        {t("employeemangement.employee.editemployeetitle")}
                    </h4>
            ...
            <div className="card shadow-sm p-4">
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.usertype")}</label>
                        <Select
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.zone")}</label>
                        <Select
                            options={zoneOptions}
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.id")}</label>
                        <input
                            type="text"
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.firstname")}</label>
                        <input
                            type="text"
                            className="form-control"
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.lastname")}</label>
                        <input
                            type="text"
                            className="form-control"
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.mobile")}</label>
                        <input
                            type="text"
                            className="form-control"
                ...
                <div className="row mb-3">
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.email")}</label>
                        <input
                            type="email"
                            className="form-control"
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.password")}</label>
                        <input
                            type="text"
                            className="form-control"
                    ...
                    <div className="col-md-4">
                        <label className="form-label">{t("employeemangement.employee.designation")}</label>
                        <input
                            type="text"
                            className="form-control"
                ...
                <div className="d-flex gap-2 mt-3">
                    <button className="btn btn-success" onClick={handleUpdate}>
                        <FaSave className="me-1" /> {t("employeemangement.employee.update")}
                    </button>
                    <button className="btn btn-secondary" onClick={handleCancel}>
                        <FaTimes className="me-1" /> {t("employeemangement.employee.cancel")}
                    </button>
                </div>
            </div>
        </div>
