  ...
  return (
    <nav aria-label="breadcrumb" className="mb-3">
      <ol className="breadcrumb bg-light rounded-3 p-2" style={{
          backgroundColor: darkMode ? "#1e1e1e" : "#117ae4ff", // dark bg / light bg
          color: darkMode ? "#e6eef8" : "#212529", // dark text / light text
        }}>
        <li className="breadcrumb-item">
          <Link to="/dashboard" className="text-primary text-decoration-none" style={{ color: darkMode ? "#90caf9" : "#0d6efd" }}>
            Home
          </Link>
        </li>
        {pathnames
