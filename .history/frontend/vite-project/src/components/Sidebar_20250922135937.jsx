  ...
  const renderMenuSection = (key, Icon, title, items) => (
    ...
    >
      ...
      {!collapsed && openMenu === key && (
        ...
        style={{
          paddingLeft: "20px",   // ✅ indent whole submenu from main menu
          margin: 0,
          borderLeft: "2px solid #cccccc", // optional left border
        }}>
          {items.map((item) => (
            <li
              key={item}
              ...
              style={{ cursor: "pointer",color: "#000000ff",whiteSpace: "nowrap",backgroundColor: "#ffffffff",textAlign: "left", paddingLeft: "6px" }}
      ...
      <div className="flex-grow-1" style={{ overflowX: "hidden", minHeight: 0 }}>
        <ul className="nav flex-column gap-1">
         {renderSingleMenu("dashboard", FaHome, "Dashboard", () => navigate("/dashboard"))}
          ...
          {renderSingleMenu("beDelivery", FaChartBar, "BE Delivery Information")}
