...
export default function Sidebar({ activeItem, setActiveItem, collapsed }) {
        ...
        <li
          style={{
            ...
            color: activeItem === title
              ? darkMode ? "#ffffff" : "#002560"
              : darkMode ? "#CCCCCC" : "#ffffff",
          }}
    ...
    <li
      ...
      style={{
        ...
        backgroundColor: activeParent === key
          ? darkMode ? "#333333" : "#ffffff"
          : darkMode ? "#121212" : "#002560",
        borderRadius: activeParent === key ? 5 : 0,
        padding: activeParent === key ? 1 : 0,
      }}
    >
      <div
            ...
            <li
              ...
              style={{
                ...
                color: activeItem === item
                  ? darkMode ? "#ffffff" : "#002560"
                  : darkMode ? "#CCCCCC" : "#002560",
                backgroundColor: activeItem === item
                  ? darkMode ? "#333333" : "#ffffff"
                  : "transparent",
                borderRadius: activeItem === item ? 4 : 0,
                whiteSpace: "nowrap",
                textAlign: "left",
                width: "100%",
                paddingLeft: 55,
  ...
  return (
    <aside
      className={`d-flex flex-column vh-100 ${collapsed ? "align-items-center" : ""}`}
      style={{
    ...
    >
      ...
      >
        <img
          ...
          alt="Logo"
          className="img-fluid"
          style={{ height: collapsed ? 40 : 43 }}
        />
      </div>

      <div className="flex-grow-1" style={{ overflowX: "hidden", minHeight: 0 }}>
        <ul className="nav flex-column gap-1">
          {renderSingleMenu("dashboard", FaHome, t("sidebar.dashboard"), () => navigate("/dashboard"))}
          ...
          {renderSingleMenu("employee", FaUserTie, t("sidebar.employeeManagement"), () => navigate("/employee"))}
