...
const Table = ({ data, columns, totalRecords, onPaginationChange, onFilteredRowsChange, collapsed }) => {
  ...
  const tableClass = `table ${darkMode ? "table-dark" : "table-striped table-hover"} table-bordered table-sm`;
  const thStyle = {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="small text-center w-100 w-md-auto">
          {pageIndex + 1} of {pageCount} pages ({totalRecords} items)
        </span>

        <nav aria-label="Table Pagination" className="w-100 w-md-auto">
          <ul
            className={`pagination mb-0 flex-wrap justify-content-center justify-content-md-end ${
