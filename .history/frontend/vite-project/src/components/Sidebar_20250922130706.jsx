  ...
  const renderMenuSection = (key, Icon, title, items) => (
    ...
    >
      ...
      {!collapsed && openMenu === key && (
        <ul className="nav flex-column border-start">
          {items.map((item) => (
            <li
              key={item}
              className={`nav-link small ${
              ...
              style={{ cursor: "pointer",color: "#000000ff",whiteSpace: "nowrap",backgroundColor: "#ffffffff",textAlign: "left", padding left: "6px 12px" }}
