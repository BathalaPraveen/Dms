...
const Table = ({ data, columns, totalRecords, onPaginationChange, onFilteredRowsChange }) => {
                    ...
                    {header.column.getCanFilter() && activeFilter === header.id && (
                      <div className="mt-1">
                        <DebouncedInput
                          ...
                          className='{form-control form-control-sm table-bordered' style={{backgroundColor: darkMode ? "#3d3d3dff" : "#ffff",color: darkMode ? "#e6eef8" : "#212529"}}
                        />
                      </div>
                    )}
                  </div>
