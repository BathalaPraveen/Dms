      ...
      >
        <li
          style={{
            ...
            ? darkMode
              ? "#333333" // active parent dark
              : "#ffffff" // active parent light
            : "transparent",
        ...
        {items.map((it) => (
          <li
            ...
            style={{
              ...
              ? darkMode
                ? "#333333" // active item dark
                : "#ffffff" // active item light
              : "transparent",
            color: activeItem === it
              ? darkMode
                ? "#ffffff"
  ...
  const renderMenuSection = (key, Icon, title, items) => (
    <li
      ...
      style={{
        ...
        ? darkMode
          ? "#333333"   // active parent background in dark
          : "#ffffff"   // active parent background in light
        : darkMode
          ? "#121212"   // normal dark
          : "#002560",  // normal light
    ...
    >
      <div
        ...
        style={{
         ...
         backgroundColor: darkMode ? "#862929ff" : "#002560",
          fontSize: "14px",
        }}
          ...
          {items.map((item) => (
            <li
              ...
              style={{
                ...
                ? darkMode
                  ? "#CCCCCC" // active text dark
                  : "#ffffff" // active text light
                : darkMode
                  ? "#CCCCCC" // normal text dark
                  : "#002560", // normal text light
                backgroundColor: activeItem === item
                ? darkMode
                  ? "#333333" // active background dark
                  : "#002560" // active background light
                : "transparent",
