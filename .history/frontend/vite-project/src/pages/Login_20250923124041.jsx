...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({ toast: true, icon: "success", title: "Logged in successfully!", position: "top-right", showConfirmButton: false, timer: 3000, timerProgressBar: true });
      setTimeout(() => navigate("/dashboard"), 1500);
    } catch (err) {
      Swal.fire({ toast: true, icon: "error", title: err.response?.data?.msg || "Login failed!", position: "top-right", showConfirmButton: false, timer: 3000, timerProgressBar: true });
    }
  };
