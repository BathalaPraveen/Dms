...
import { FaPencilAlt, FaTrashAlt, FaRegFilePdf, FaFileExcel } from "react-icons/fa";
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
          ...
          <div className="d-flex flex-wrap gap-2">
            ...
            <button
              ...
              onClick={() => navigate(`/supplier/supplieremp/add/${supplierIndex}`)}
            >
              Add Employee
            </button>
            <button className="btn btn-primary" onClick={() => navigate("/supplier/supplieremp/add")}><FaPlus /></button>
          </div>
        </div>
      </div>
