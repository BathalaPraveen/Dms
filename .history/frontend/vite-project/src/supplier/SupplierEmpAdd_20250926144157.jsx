  ...
  <div className="container mt-3">
    ...
    >
      <div className="card-body d-flex justify-content-between align-items-center">
        <h4 className="card-title mb-0">{t("employee.addEmployee")}</h4>
      ...
      <div className="row mb-3">
        <div className="col-md-4">
          <label className="form-label">
            {t("employee.employeeId")} <span className="text-danger">*</span>
          </label>
          <input
            type="text"
        ...
        <div className="col-md-4">
          <label className="form-label">
            {t("employee.employeeType")} <span className="text-danger">*</span>
          </label>
          <Select
