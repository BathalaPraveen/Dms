...
const SupplierEmpList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("employeeName", { header: t("supplier.employeeName"), cell: (info) => info.getValue() }),
      columnHelper.accessor("employeeId", { header: t("supplier.employeeType"), cell: (info) => info.getValue() }),
