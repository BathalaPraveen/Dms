...
const EmployeeEdit = () => {
  ...
  console.log("Supplier Index:", supplierIndex, "Employee Index:", employeeIndex);
    if (suppliers[supplierIndex] && suppliers[supplierIndex].empList) {
      const emp = suppliers[supplierIndex].empList[employeeIndex];
      if (emp) {
  ...
  const handleUpdate = () => {
    ...
    suppliers[supplierIndex].empList[employeeIndex] = formData;
