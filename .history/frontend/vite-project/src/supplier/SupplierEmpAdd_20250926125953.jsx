...
const EmployeeAdd = () => {
  ...
  const { darkMode } = useTheme();
   const { supplierIndex } = useParams(); // top-level hook
   console.log("suppliers:", supplierIndex);
...
const handleSave = () => {
  ...
  const supplierIndexNum = Number(supplierIndex);
  console.log("suppliers:", suppliers);
console.log("supplierIndexNum:", supplierIndexNum);
