...
const SupplierEmpList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("employeeId", { header: t("employee.employeeName"), cell: (info) => info.getValue() }),
      columnHelper.accessor("employeeType", { header: t("employee.employeeName"), cell: (info) => info.getValue() }),
