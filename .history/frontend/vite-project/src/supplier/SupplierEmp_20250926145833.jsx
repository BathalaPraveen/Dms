...
const SupplierEmpList = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("employeeName", { header: t("employee.employeeName"), cell: (info) => info.getValue() }),
      columnHelper.accessor("employeeId", { header: t("employee.employeeType"), cell: (info) => info.getValue() }),
      columnHelper.accessor("employeeType", { header: t("employee.employeeType"), cell: (info) => info.getValue() }),
